      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.card}>
          ...
          <Text style={styles.content}>
            ...
            복잡한 분리 기준으로 인해 많은 사람들이 혼란을 겪고 있습니다.{"\n\n"}

            따라서 저희는 이러한 문제를 해결하고자 YOLO 모델을 기반으로 사용자가 촬영한 쓰레기를
            판별하고, 정확한 분리배출 방법을 안내하는 본 애플리케이션을 개발하게 되었습니다.{"\n\n"}

            누구나 쉽고 직관적으로 사용할 수 있도록 개발하였으며, 일상 속에서 올바른 분리배출 실천을 돕고
             도와 궁극적으로 탄소중립에 기여하는 것이 저희의 목표입니다.
          </Text>
        </View>

...
export default function JamGuide(): React.JSX.Element {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabContainer}>
          <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
            <TouchableOpacity style={styles.tab} onPress={() => router.push('/glass/bottle' as const)}>
              <Text style={[styles.tabText, { fontSize }]}>음료/주류병</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.tab} onPress={() => router.push('/glass/jam' as const)}>
              <Text style={[styles.tabText_selected, { fontSize }]}>잼같은 유리병</Text>
            </TouchableOpacity>
          </View>
      </View>
      ...
      >
        ...
        <Image source={require('../../assets/images/guideline/jam3.jpg')} style={styles.image} />

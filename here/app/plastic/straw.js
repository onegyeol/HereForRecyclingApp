...
export default function CupGuide() {
  ...
  return (
    <View style={styles.container}>
      {/* 상단 제목 */}
      <Text style={styles.title}>빨대 분리배출</Text>
      ...
      <View style={styles.tabContainer}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          ...
          <TouchableOpacity style={styles.tab} onPress={() => router.push('/plastic/straw')}>
            <Text style={styles.tabText_selected}>빨대</Text>
          </TouchableOpacity>
        </ScrollView>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <Image source={require('../../assets/images/guideline/straw2.png')} style={styles.image} />

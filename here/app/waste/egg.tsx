...
export default function EggGuide(): React.JSX.Element {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.tabContainer}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            ...
            <TouchableOpacity style={styles.tab} onPress={() => router.push('/waste/egg' as const)}>
              <Text style={[styles.tabText_selected
                , { fontSize }]}>계란 껍질</Text>
            </TouchableOpacity>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Image source={require('../../assets/images/guideline/egg1.jpg')} style={styles.image} />
        <Text style={[styles.description, { fontSize }]}>
          계란 껍질은
        </Text>

        <Image source={require('../../assets/images/guideline/egg2.jpg')} style={styles.image} />

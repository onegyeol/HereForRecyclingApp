...
export default function RecepiptGuide(): React.JSX.Element {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.tabContainer}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            ...
            <TouchableOpacity style={styles.tab} onPress={() => router.push('/waste/receipt' as const)}>
              <Text style={[styles.tabText_selected, { fontSize }]}>영수증</Text>
            </TouchableOpacity>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Image source={require('../../assets/images/guideline/receipt1.jpg')} style={styles.image} />
        <Text style={[styles.description, { fontSize }]}>
          영수증은 재활용이 불가능한{"\n"}
          감열지로 만들어졌기에
        </Text>

        <Image source={require('../../assets/images/guideline/receipt2.jpg')} style={styles.image} />

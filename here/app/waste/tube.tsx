...
export default function TubeGuide(): React.JSX.Element {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.tabContainer}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            ...
            <TouchableOpacity style={styles.tab} onPress={() => router.push('/waste/tube' as const)}>
              <Text style={[styles.tabText_selected, { fontSize }]}>튜브형 용기</Text>
            </TouchableOpacity>
          </ScrollView>
        </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Image source={require('../../assets/images/guideline/toothpaste1.jpg')} style={styles.image} />
        <Text style={[styles.description, { fontSize }]}>
          치약과 같은 튜브형 타입은
        </Text>

        <Image source={require('../../assets/images/guideline/toothpaste2.jpg')} style={styles.image} />

...
export default function BornGuide(): React.JSX.Element {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.tabContainer}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            ...
            <TouchableOpacity style={styles.tab} onPress={() => router.push('/waste/born' as const)}>
              <Text style={[styles.tabText_selected, { fontSize }]}>뼈</Text>
            </TouchableOpacity>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Image source={require('../../assets/images/guideline/born1.jpg')} style={styles.image} />
        <Text style={[styles.description, { fontSize }]}>
          치킨 뼈, 생선 뼈 등은
        </Text>

        <Image source={require('../../assets/images/guideline/born2.jpg')} style={styles.image} />

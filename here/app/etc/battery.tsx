...
export default function BatteryGuide(): React.JSX.Element {
  ...
  const descriptions = [
    '다 사용한 배터리는',
    '폐건전지 수거함에 버려주세요.',
    '폐건전지 수거함은 아파트 쓰레기장, 주민 센터 등에서 볼 수 있어요',
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
          ...
          <TouchableOpacity style={styles.tab} onPress={() => router.push('/etc/battery' as const)}>
            <Text style={[styles.tabText_selected, { fontSize }]}>배터리</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.tab} onPress={() => router.push('/etc/bulb' as const)}>
            <Text style={[styles.tabText, { fontSize }]}>전구</Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      >
        <Image source={require('../../assets/images/guideline/battery1.jpg')} style={styles.image} />
        <Text style={[styles.description, { fontSize }]}>
          다 사용한 배터리는 
        </Text>

        <Image source={require('../../assets/images/guideline/battery2.jpg')} style={styles.image} />
        <Text style={[styles.description_last, { fontSize }]}>
          폐건전지 수거함에 {"\n"}
          버려주세요.
        </Text>

        <Image source={require('../../assets/images/guideline/battery3.jpg')} style={styles.image} />
        <Text style={[styles.description_last, { fontSize }]}>
          폐건전지 수거함은 {"\n"}
          아파트 쓰레기장, 주민 센터 등에서{"\n"}
          볼 수 있어요.

...
export default function PillGuide(): React.JSX.Element {
  ...
  const descriptions = [
    '남은 약이나 유통기한이 지난 약은',
    '폐의약품 수거함에 버려주세요.',
    '폐의약품 수거함은 약국, 주민 센터 등에서 볼 수 있어요',
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
          <TouchableOpacity style={styles.tab} onPress={() => router.push('/etc/pill' as const)}>
            <Text style={[styles.tabText_selected, { fontSize }]}>의약품</Text>
          </TouchableOpacity>
      ...
      >
        <Image source={require('../../assets/images/guideline/pill1.jpg')} style={styles.image} />
        <Text style={[styles.description, { fontSize }]}>
          남은 약이나 {"\n"}
          유통 기한이 지난 약은
        </Text>

        <Image source={require('../../assets/images/guideline/pill2.jpg')} style={styles.image} />
        <Text style={[styles.description_last, { fontSize }]}>
          폐의약품 수거함에 {"\n"}
          버려주세요.
        </Text>

        <Image source={require('../../assets/images/guideline/pill3.jpg')} style={styles.image} />
        <Text style={[styles.description_last, { fontSize }]}>
          폐의약품 수거함은 {"\n"}
          약국, 주민 센터 등에서{"\n"}
          볼 수 있어요.
